...
##The exam
To start the exam download the word document [*Unix_test.docx*] (https://github.com/BacterialCommunitiesAndPopulation/LinuxExam_Friday13thMay/blob/master/Unix_test.docx) (click "View Raw" to download it) follow the instructions, feel the boxes, save the document including your name in the filename and send it to mirko.rossi@helsinki.fi and jenni.hultman@helsinki.fi by today at 13:00.
